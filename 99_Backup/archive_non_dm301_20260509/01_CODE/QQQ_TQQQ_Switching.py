    ...
    for idx in stock_data[tickers[0]].index:
        try:
            ...
            if count == 0:
                ...
                if(martin_gale):
                    capital_martin = capital / 2
                    capital -= capital_martin
                else:
                    capital_martin = 0
                martin_gale = True
                ...
                if bought_today:
                    ...
                    for ticker in bought_ticker:
                        ...
                        if stock_data[ticker].loc[idx, "Low"] <= bought_ticker[ticker]["buy_price"] * (1-stop_loss):
                            ...
                            capital += capital_martin
                            # print(f"capital = {capital}, recovered")
                            capital_martin = 0
...
# whole_tickers = [("HIBL","HIBS"),("TECL","TECS"),("TQQQ","SQQQ"),("WEBL","WEBS"),("UMDD","SMDD"),("DRN","DRV"),("FAS","FAZ"),("SPXL","SPXS"),("YINN","YANG")]
